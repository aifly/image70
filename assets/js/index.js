!function(){
            ...
            var util = {
				...
				host: "https://testactivity.xhsxmt.com", //测试域名：https://testxlive.xinhuaapp.com
                layout:function(){
                    var faceImgs = '';
					...
					this.imgList[this.currentIndex].forEach(function(img,i){
                        if(img.title){
                            html+="<div class='zmiti-team zmiti-swpier-item hide'>\
                ...
                init:function(){
					...
					this.$('#container').innerHTML = '<div class="zmiti-swpier-item hide loading" style="height:800px;"><span>数据加载中...</span></div>';
